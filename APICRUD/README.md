...
1. Navega a la carpeta `database` en el directorio del proyecto.
2. Abre el archivo `db_config.py`.
3. Localiza la variable `sqlite_file_name`.
4. Establece el `sqlite_file_name` al nombre de archivo que desees para la base de datos SQLite, por ejemplo:
   ```python
